...
// Variables listenings for all sort events for driver standings
...
let driverSort = document.getElementById("driver").addEventListener("click", sortByDriver);
let nationalitySort = document.getElementById("nationality").addEventListener("click", sortByNationality);
let carSort = document.getElementById("car").addEventListener("click", sortByCar);
...
// Since sorting by points and position would end up with the same display, use the points index again
// little cheaty but who's to know
